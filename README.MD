...
###### Description
 ...
 This action pack enables you to download files from an SMB/CIFS server.
...
Please refer to the link for [package documentation](source/ae/DOCUMENTATION/PCK.AUTOMIC_SMB.PUB.DOC.xml)
